...
class KeysState extends FlxState
{
	...
	override public function update(elapsed:Float):Void
	{
		...
		if (w.animation.frameIndex == 1 && a.animation.frameIndex == 1 && s.animation.frameIndex == 1 && d.animation.frameIndex == 1
			&& up.animation.frameIndex == 1 && left.animation.frameIndex == 1 && down.animation.frameIndex == 1 && right.animation.frameIndex == 1)
		{
			fadeOut(null);
		}
	}
